  ...
  // js 自动加前缀,传入一个标准css 属性 
     autoPrefix( cssAttr){
   	    ...
   	    var obj = {      'animation':'' ,
   	     ...
   	     var pf = obj.keys().find((item)=>{
   	    	           return elementStyle[item] !== undefined
   	          })
   	      return pf.substr(0,  pf.length-9)+ cssAttr.charAt[0].toUpperCase() + cssAttr.substr(1).toLowerCase();
     },
